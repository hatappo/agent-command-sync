...
| [agent-skill-porter](https://github.com/skill-mill/agent-skill-porter) | 個人 | フォーマット変換・双方向同期 |
...
| 機能 | skills.sh | agent-skills-cli | skillshare | .agents | agent-skill-porter |
|------|:---------:|:----------------:|:----------:|:-------:|:------------------:|
| Skills 対応 | ✓ | ✓ | ✓ | ✓ | ✓ |
| Commands 対応 | - | - | - | - | ✓ |
| マーケットプレイス | ✓ | ✓ | ✓ | - | - |
...
| 特徴 | skills.sh | agent-skills-cli | skillshare | .agents | agent-skill-porter |
|------|:---------:|:----------------:|:----------:|:-------:|:------------------:|
...
# Skills 同期
sk sync claude codex -t skills         # Skills のみ
sk sync claude gemini -t both          # Commands + Skills

# オプション
sk sync claude gemini -n               # ドライラン（プレビュー）
sk sync claude gemini -f my-skill      # 特定スキルのみ
sk sync claude gemini --sync-delete    # 孤立ファイル削除
```
...
**リポジトリ**: https://github.com/skill-mill/agent-skill-porter
