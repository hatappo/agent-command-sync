/**
 * OpenCode Skill <-> SemanticIR bidirectional converter
 */

import type { OpenCodeSkill, SemanticConverter, SemanticIR, ConverterOptions } from "../types/index.js";
...
export class OpenCodeSkillConverter implements SemanticConverter<OpenCodeSkill> {
  toIR(source: OpenCodeSkill): SemanticIR {
  ...
  fromIR(ir: SemanticIR, options?: ConverterOptions): OpenCodeSkill {
