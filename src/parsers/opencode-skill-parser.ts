...
import type { OpenCodeSkill, Parser } from "../types/index.js";
...
export class OpenCodeSkillParser implements Parser<OpenCodeSkill> {
  /**
   * Parse a skill directory and generate an OpenCodeSkill object
   */
  async parse(dirPath: string): Promise<OpenCodeSkill> {
    try {
  ...
  /**
   * Validate an OpenCodeSkill object
   */
  validate(data: OpenCodeSkill): boolean {
  ...
  /**
   * Convert an OpenCodeSkill object to SKILL.md format
   */
  stringify(skill: OpenCodeSkill): string {
   ...
   */
  async writeToDirectory(skill: OpenCodeSkill, targetDir: string): Promise<void> {
