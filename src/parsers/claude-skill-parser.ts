...
import type { ClaudeSkill, Parser, SupportFile } from "../types/index.js";
...
export class ClaudeSkillParser implements Parser<ClaudeSkill> {
  /**
   * Parse a skill directory and generate a ClaudeSkill object
   */
  async parse(dirPath: string): Promise<ClaudeSkill> {
    try {
  ...
  /**
   * Validate a ClaudeSkill object
   */
  validate(data: ClaudeSkill): boolean {
  ...
  /**
   * Convert a ClaudeSkill object to SKILL.md format
   */
  stringify(skill: ClaudeSkill): string {
   ...
   */
  async writeToDirectory(skill: ClaudeSkill, targetDir: string): Promise<void> {
